    ...
    <div class="p-6">
        ...
        <div class="mb-6 space-y-1.5 text-center sm:text-left border-b border-gray-200 pb-4">
            ...
            <p class="text-sm text-muted-foreground">
                {{ $isEditing ? 'Ubah detail transaksi di bawah ini.' : 'Catat pemasukan atau pengeluaran baru.' }}
            </p>
        </div>
        ...
        <form wire:submit="save" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <x-form-input
                    ...
                    placeholder="Cth: INV.001 atau Nota #123"
                    type="text"
            ...
            <!-- Type -->
            <div class="space-y-3">
                <x-input-label for="type" :value="__('Tipe')" :required="true" />
            ...
            <div class="mt-6 flex justify-end gap-3 border-t border-gray-200 pt-4">
                ...
                <x-primary-button type="submit" wire:loading.attr="disabled">
                    ...
                    {{ $isEditing ? __('Simpan Perubahan') : __('Simpan Transaksi') }}
                </x-primary-button>
            </div>
        </form>
    </div>
