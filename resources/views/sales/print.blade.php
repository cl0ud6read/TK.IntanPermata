    ...
    <div class="container">
        ...
        <div class="header">
            <div class="header-left">
                <div class="logo-box">TK</div>
                <div class="company-info">
                    <div class="company-name">{{ \App\Models\Setting::get('store_name', 'TK.INTANPERMATA') }}</div>
                    <div class="company-desc">{{ \App\Models\Setting::get('store_tagline', 'Menjual: Berbagai Jenis Barang Jadi Hasil Produksi Keramik') }}</div>
                    <div class="company-address">{{ \App\Models\Setting::get('store_address', 'Jalanin aja dulu, bismillah') }}</div>
                </div>
            </div>
