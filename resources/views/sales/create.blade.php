                                ...
                                if (data.snap_token) {
                                    ...
                                    window.snap.pay(data.snap_token, {
                                        onSuccess: (result) => {
                                            ...
                                            this.clearStorage();
                                            this.resetForm();
                                            this.$dispatch('toast', { message: 'Payment Success!', type: 'success' });
                                        },
                                        onPending: (result) => {
                                            if (data.print_url) window.open(data.print_url, '_blank');
                                            this.clearStorage();
                                            this.resetForm();
                                            this.$dispatch('toast', { message: 'Waiting for payment...', type: 'warning' });
                                        },
                                        onError: (result) => {
                                            this.$dispatch('toast', { message: 'Payment failed!', type: 'error' });
                                        },
                                        onClose: () => {
                                            this.$dispatch('toast', { message: 'Payment popup closed.', type: 'info' });
                                        }
                                    });
                                } else {
                                    if (data.print_url) {
