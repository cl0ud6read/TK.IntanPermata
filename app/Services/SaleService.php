...
class SaleService
{
        ...
        return DB::transaction(function () use ($data) {
            try {
                ...
                foreach ($data->items as $itemData) {
                    ...
                    // Removed direct stock deduction. Now handled by GudangKeluarController
    ...
    public function cancelSale(Sale $sale, ?string $reason = null): Sale
    {
        return DB::transaction(function () use ($sale, $reason) {
            try {
                ...
                // Stock restoration is now handled through explicit reversal movements
                // by the warehouse or automatically if GudangKeluarController triggers a reversal
    ...
    public function restoreSale(Sale $sale): Sale
    {
        return DB::transaction(function () use ($sale) {
            ...
            // Stock is now handled by GudangKeluarController. No need to deduct here.
