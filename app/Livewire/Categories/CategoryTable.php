...
final class CategoryTable extends PowerGridComponent
{
    ...
    public function setUp(): array
    {
        ...
        return [
            PowerGrid::exportable('category_export_' . now()->format('Y_m_d'))
    ...
    public function fields(): PowerGridFields
    {
        return PowerGrid::fields()
            ...
            ->add('name')
            ->add('slug')
            ->add('description', fn(Category $model) => Str::limit($model->description, 50))
            ->add('created_at');
    }
    ...
    public function actions(Category $row): array
    {
        $actions = [
            Button::add('view')
                ...
                ->dispatch('show-category', ['category' => $row->id])
        ...
        if (auth()->user()->role === 'admin') {
            $actions[] = Button::add('edit')
                ...
                ->dispatch('edit-category', ['category' => $row->id])
            ...
            $actions[] = Button::add('delete')
                ...
                ->dispatch('open-delete-modal', [
                    'component' => 'categories.category-table',
                    'method' => 'delete',
                    'params' => ['rowId' => $row->id],
    ...
    public function delete($rowId, CategoryService $service): void
    {
