...
final class UnitTable extends PowerGridComponent
{
    ...
    public function setUp(): array
    {
        ...
        return [
            PowerGrid::exportable('units_export_' . now()->format('Y_m_d'))
    ...
    public function actions(Unit $row): array
    {
        $actions = [
            Button::add('view')
                ...
                ->dispatch('show-unit', ['unit' => $row->id])
                ->tooltip('View Unit'),
        ...
        if (auth()->user()->role === 'admin') {
            $actions[] = Button::add('edit')
                ...
                ->dispatch('edit-unit', ['unit' => $row->id])
                ->tooltip('Edit Unit');
            ...
            $actions[] = Button::add('delete')
                ...
                ->dispatch('open-delete-modal', [
                    ...
                    'params' => ['rowId' => $row->id],
                    'title' => 'Delete Unit?',
                    'description' => "Are you sure you want to delete unit '{$row->name}'? This action cannot be undone.",
                ])
                ->tooltip('Delete Unit');
        }
