...
class SettingSeeder extends Seeder
{
    ...
    {
        Setting::set('store_name', 'TK.INTANPERMATA');
        Setting::set('store_address', 'Jalanin aja dulu, bismillah');
        Setting::set('store_phone', '081234567890');
        Setting::set('store_tagline', 'Menjual: Berbagai Jenis Barang Jadi Hasil Produksi Keramik');
